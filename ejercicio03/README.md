...
Luego de pullear cada imagen consultamos con el comando:
```bash
docker inspect nicopaez/<contenedor>
```

Ubicamos el apartado de `layers`. En cada caso:

- `nicopaez/passwordapi-java:java8-alpine`: 4 capas
  ```
...
- `nicopaez/passwordapi-java:java8-fabric`: 9 capas
  ```
  "sha256:73046094a9b835e443af1a9d736fcfc11a994107500e474d0abf399499ed280c",
...
- Observación: Ambas imágenes comparten la primer capa.